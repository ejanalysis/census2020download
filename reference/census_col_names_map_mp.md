# Table that maps some Census variable names to short friendly variable names - NORTHERN MARIANA ISLANDS
...
[census_col_names_map_island](https://ejanalysis.github.io/census2020download/reference/census_col_names_map_island.md)
