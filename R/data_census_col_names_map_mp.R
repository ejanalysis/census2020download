#' @name census_col_names_map_mp
#' @docType data
#' @title Table that maps some Census variable names to short friendly variable names - NORTHERN MARIANA ISLANDS
#' @details
#'
...
#'
#' @seealso [census_col_names_map_island]
#'
NULL
