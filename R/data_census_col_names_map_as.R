#' @name census_col_names_map_as
#' @docType data
#' @title Table that maps some Census variable names to short friendly variable names - AMERICAN SAMOA
#' @details
#'
