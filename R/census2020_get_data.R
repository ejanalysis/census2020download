...
#'       
#' @param folder path for downloaded files, or try tempdir()
#' @param folderout path for assembled results files, or try tempdir()
...
#'
#' @seealso [census2020_save_datasets()] which creates individual data.tables
